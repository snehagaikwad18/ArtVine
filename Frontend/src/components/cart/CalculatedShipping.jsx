...
const CalculatedShipping = () => {
  return (
    <div className='bg-white p-5 rounded-md w-[25%] shadow-2xl px-6  '>
      <div className="flex flex-col gap-5">
        <h1 className='font-semibold text-[25px] ' >Calculated Shipping</h1>
        <div className="flex flex-col gap-5  ">
          ...
          <Autocomplete
            ...
            sx={{
              ...
              "& .MuiOutlinedInput-input": {
                backgroundColor: "slate-100", // Background inside the text area
              },
          ...
          <Button variant="contained"
            sx={{
              ...
              borderRadius: "9999px", // Equivalent to rounded-full in Tailwind CSS
              backgroundColor: "black", // Optional: Button color
              height: "45px",
              "&:hover": {
                backgroundColor: "#272525", // Optional: Hover color
              },
            }}
          >Update </Button>
        </div>
      ...
      <hr className='py-4  border-t-2 border-gray-300 mx-3' />
      {/* coupon code  */}
      <div className="p-5  w-full flex flex-col gap-5 shadow-xl rounded-[20px] border-t  ">
        <h1 className='font-semibold text-[25px] ' >Coupon code</h1>
        <p>Simply apply the code to get a percentage or fixed amount off your total order.
          For example, use the code <strong>DISCOUNT10</strong> to save 10% on your next order!
        </p>
      ...
      <div className="rounded-xl p-5 bg-orange-300 mt-5 w-full flex flex-col gap-5 ">
        <div className="flex-col flex gap-1  ">
          ...
          <div className="flex flex-row flex-1 justify-between items-center ">
            <h1>Discount</h1>
            <h1 className='text-white' >-$71.51</h1>
          </div>
          <div className="flex flex-row flex-1 justify-between items-center ">
            <h1 className='font-bold'>Cart Total</h1>
            <h1 className='font-bold text-[20px]'>$71.51</h1>
          </div>
        </div>
        <Button variant="contained"
          ...
          sx={{
            ...
            fontWeight: "bold", // Sets the font weight
            borderRadius: "9999px", // Equivalent to rounded-full in Tailwind CSS
            backgroundColor: "white", // Optional: Button color
            height: "45px",
            "&:hover": {
              backgroundColor: "#f5f5f5", // Optional: Hover color
            },
            width: "100%"
