...
const Navbar = () => {
    ...
    return (
        <div
    className={`transition-all fixed top-0 w-full z-10 ${isVisible ? 'opacity-100' : 'opacity-0'} ${isVisible ? 'pointer-events-auto' : 'pointer-events-none'}`}
>
    <div className="flex flex-row w-full items-center justify-between gap-5 font-semibold text-[17px] p-5 overflow-x-hidden">
        <h1 className='text-white text-[25px]'>S.Gaikwad</h1>
        <div className="flex flex-row gap-5 overflow-x-hidden">
            ...
            <Link className="cursor-pointer">Track Order</Link>
        </div>
